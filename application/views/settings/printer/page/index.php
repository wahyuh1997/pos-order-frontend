<div class="d-flex justify-content-between">
  ...
  <div class="ml-auto">
    <a href="<?= base_url('settings/printer/add'); ?>" class="btn btn-sm btn-primary btn-round">{{Add New}}</a>
  </div>
</div>
...
<div class="panel panel-inverse">
  ...
  <div class="panel-body">
    <!-- html -->
    <table id="dtb-serverside" href="<?= base_url('datatables/printer/get'); ?>" class="table table-striped table-bordered align-middle">
      <thead>
        <tr>
          <th width="1%">#</th>
          <th width="10%"></th>
