...
<!-- panel search -->
<form id="regCrudForm" data-redurl="<?= base_url('master_data/menu_table'); ?>" method="POST">
  <div class="panel panel-inverse">
    ...
    <div class="panel-body">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-6">
          <input type="text" class="form-control text-capitalize" id="nama_kategori" name="nama_kategori" min="1" max="100" value="<?= $data['no_meja']; ?>" autocomplete="off" required>
        </div>
      </div>
      <div class="panel-footer text-end">
        <a href="<?= base_url('master_data/menu_table'); ?>" class="btn btn-secondary">Back</a>
