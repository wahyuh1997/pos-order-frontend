  ...
  <div class="ml-auto">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="<?= base_url('master-data/menu-ingredients/add'); ?>">Single</a></li>
        <li>
          <hr class="dropdown-divider">
        </li>
        <li><a class="dropdown-item" href="<?= base_url('master-data/menu-ingredients/bulk'); ?>">Bulk</a></li>
      </ul>
    </div>
  </div>
</div>
