...
(function ($) {
	...
	var isDragged = false,
		...
		templates = {
			...
			buttonSave: $('<button type="button" class="btn btn-primary btn-sm ml-1" id="bcPaint-export"><i class="fas fa-download"></i> Save</button>')
		},
		paintCanvas,
		paintContext;
	...
	$.extend(true, $.fn.bcPaint, {
		...
		export: function () {
			...
			// return '<img src="' + imgData + '" alt="Exported Image"/>';
